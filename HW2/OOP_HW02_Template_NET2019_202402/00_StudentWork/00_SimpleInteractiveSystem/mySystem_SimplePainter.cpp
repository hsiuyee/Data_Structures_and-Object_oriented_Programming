...
void SIMPLE_PAINTER::askForInput( )
{
    ...
    cout << "title: mini-galaxy\n";
    cout << "Please use keyboard and mouse to control" << endl;
    cout << "'s', 'S': Show the student information on the console window, including name, ID, and email address.\n";
    cout << "'i,', 'I': Show the title and key usage of this program.\n";
    cout << "'n', 'N': Decrease the brush size.\n";
    cout << "'m', 'M': Increase the brush size.\n";
    cout << "'1': Set the brush color to red.\n";
    cout << "'2': Set the brush color to green.\n";
    cout << "'3': Set the brush color to blue.\n";
    cout << "'r': Reset the canvas. Generate the red, green, and blue color components for each pixel randomly in a uniform manner.\n";
}
...
void SIMPLE_PAINTER::drawAt(int x, int y, const vector3 &color, double w )
{
    ...
    // fill/modify your own stuff
    //
    //vector3 cuurent_color = mCanvas[index];
